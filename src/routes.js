...
const routes = [
    ...
    { path: '/admin/partners/:id', exact: true, name: 'Edit Partner', component: PartnerEdit},
    { path: '/admin/partners/edit/:id', exact: true, name: 'Partner Detail', component: PartnerDetail},
];
